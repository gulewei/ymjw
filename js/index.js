...
/***/ function(module, exports, __webpack_require__) {
	...
	$(function () {
	    ...
	    $.map(
	        [Header, Banner, Recommends, Guess, Popular, Interest, Special, BrandWall, Taste, Channel, Footer],
	        function (module) {
	            if (module)
	                module();
	        }
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function () {
		var pics = $("#slides li");
		var flashBtns = $("#flashBtn a");
		var index = 0;
		var timer = null;
		var interval = 3000;
		// init
		pics.css({ opacity: 0, zIndex: -1 }).eq(0).css({ opacity: 1, zIndex: 0 });
		// move
		flashBtns.on('mouseenter', function () {
			flashBtns.removeClass('active').eq($(this).index()).addClass('active');
			pics.stop(true).css({ opacity: 0, zIndex: -1 }).eq($(this).index()).stop(true).animate({ opacity: 1, zIndex: 0 }, 500, 'swing');
			index = $(this).index();
			console.log(timer);
		});
		pics.hover(
			...
			function () {
				$(this).find('img').stop(true).animate({ width: $(this).width(), height: $(this).height(), left: 0, top: 0 }, 1500, 'swing');
		...
		function autoPlay() {
			var i = index + 1;
			realI = i >= flashBtns.length ? 0 : i;
			flashBtns.eq(realI).mouseenter();
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function () {
		...
		//------------------ 顶部推荐：精品闪购 -------------------------------
		(function () {
			var flashBy = $("#recommends .left .flash-buy");
			var flashBtn = $("div", flashBy);
			var hideObj = $(".flash-img", flashBy);
			var status = true;
		...
		//------------------ 顶部推荐：选项卡 -------------------------------
		(function () {
			var topTab = $("#recommends .left .tabs");
			var tabTop = $(".tab-top li", topTab);
			var tabBottom = $(".tab-bottom>li", topTab);
			tabTop.on('mouseenter', function () {
				var index = $(this).index();
				tabBottom.removeClass('active');
				tabTop.removeClass('active');
				$(this).addClass('active');
				tabBottom.eq(index).addClass('active');
			})
		})();
		...
		//------------------ 顶部推荐： 垂直选项卡 ---------------------------
		(function () {
			var vertTop = $("#vert-top a");
			var vertBottom = $("#vert-bottom .con");
			vertTop.on('mouseenter', function () {
				vertTop.removeClass('active');
				$(this).addClass('active');
				vertBottom.stop(true).animate({ top: -$(this).index() * 360 }, 500)
			})
		})();
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function () {
		...
		chalRank.each(function () {
			...
			var start = $(this).height() > 605 ? 2 : 0;
			console.log('statr: ', $(this).height());
